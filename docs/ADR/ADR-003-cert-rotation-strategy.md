# ADR-003: Cert rotation atomicity (tmpfile + rename + atomic.Pointer[http.Client])
...
- Cons: blocks all other traffic during the rotation; defeats the goroutine model in ADR-006.
- **Rejected.**
